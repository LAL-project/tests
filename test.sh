...
function show_usage() {
	...
	echo ""
	echo "        Dmin : execute all Minimum Linear Arrangement (MLA) tests"
	echo "        Dmin_Projectve : execute MLA tests for projective arrangements"
	echo "        Dmin_Planar : execute MLA tests for planar arrangements"
	...
	echo "        gen_trees_rlr : execute generation (Rand Labelled Rooted) tests"
	echo "        gen_trees_ruf : execute generation (Rand Unlabelled Free) tests"
	echo "        gen_trees_rur : execute generation (Rand Unlabelled Rooted) tests"
	echo "        gen_arr_all_proj : execute generation (All Projective Arrangements) tests"
	...
	echo "        utils_traversal : execute traversal utils tests "
	echo ""	
