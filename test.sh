...
function show_usage() {
	...
	echo "                    utilities_isomorphism_free_tuple"
	echo "                        utilities_isomorphism_free_tuple_automatic"
	echo "                            utilities_isomorphism_free_tuple_automatic_rootless"
	echo "                            utilities_isomorphism_free_tuple_automatic_rooted"
	echo "                        utilities_isomorphism_free_tuple_manual"
	echo "                        utilities_isomorphism_free_tuple_manual_negative"
	echo "                            utilities_isomorphism_free_tuple_manual_negative_rootless"
	echo "                            utilities_isomorphism_free_tuple_manual_negative_rooted"
	echo "                        utilities_isomorphism_free_tuple_manual_positive"
	echo "                            utilities_isomorphism_free_tuple_manual_positive_rootless"
	echo "                            utilities_isomorphism_free_tuple_manual_positive_rooted"
	...
	echo "                    utilities_isomorphism_rooted_tuple"
	echo "                        utilities_isomorphism_rooted_tuple_manual"
	echo "                            utilities_isomorphism_rooted_tuple_manual_positive"
	echo "                            utilities_isomorphism_rooted_tuple_manual_negative"
	echo "                        utilities_isomorphism_rooted_tuple_automatic"
	echo ""
