...
function show_usage() {
	...
	echo "            generate_arrangements_projective_all : execute generation (All projective Arrangements) tests"
	echo "            generate_arrangements_projective_rand : execute generation (Rand projective Arrangements) tests"
	echo "            generate_arrangements_planar_all : execute generation (All planar Arrangements) tests"
	echo "            generate_arrangements_planar_rand : execute generation (Rand planar Arrangements) tests"
	echo ""
	...
	echo "                    linarr_C_brute_force_C"
	echo "                    linarr_C_brute_force_C_list"
	echo "                    linarr_C_brute_force_C_upper_bound"
	echo "                    linarr_C_brute_force_C_list_upper_bound"
	echo "                    linarr_C_brute_force_C_list_upper_bound_list"
