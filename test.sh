...
function show_usage() {
	...
	echo "                utilities_isomorphism_free : only for free trees"
	echo "                    utilities_isomorphism_free_small : small tests"
	echo "                    utilities_isomorphism_free_large : large tests"
	echo "                utilities_isomorphism_rooted : only for rooted trees"
	echo "                    utilities_isomorphism_rooted_small : small tests"
	echo "                    utilities_isomorphism_rooted_SMALL_small : small tests of SMALL algorithm"
	echo "                    utilities_isomorphism_rooted_LARGE_small : small tests of LARGE algorithm"
